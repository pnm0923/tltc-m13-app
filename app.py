...
if 'plantel' not in st.session_state:
    nombres_crudos = [
        ...
        "JUAREZ COLLADO LUCAS", "LIZARRAGA PALACIOS BAUTISTA", "LOBO HERRERA VICENTE", "LORENZO BENICIO", "MAIZEL FACUNDO",
        "MARIGLIANO LORENZO", "MARQUESTO MARTIN", "MEJAIL FRANCISCO", "MERLO BAUTISTA", "MOLINA FRANCISCO", "MOROF MAXIMILANO",
        ...
        "RODRIGUEZ BELMONTE FRANCISCO", "RUIZ LUCIANO", "RUIZ MENDILARZU MANUEL", "SALAZAR BENICIO", "SASSI BERNARDO",
